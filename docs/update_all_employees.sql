...
-- 驗證
SELECT COUNT(*) as total_employees FROM public.profiles;
SELECT site_code, COUNT(*) as count FROM public.profiles GROUP BY site_code ORDER BY site_code;